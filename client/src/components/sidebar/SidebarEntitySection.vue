...
import { SIDEBAR_DEFAULT_CAP, type SidebarCap, type SidebarCappedSectionId } from '@bookorbit/types'
...
const props = withDefaults(
  defineProps<{
    sectionId: SidebarCappedSectionId
    label: string
    items: SidebarEntity[]
    routeName: string
...
const cap = computed<SidebarCap>(() => sectionState.value.cap ?? SIDEBAR_DEFAULT_CAP)
